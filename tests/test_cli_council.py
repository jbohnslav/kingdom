...
class TestCouncilAsk:
    def test_ask_creates_thread_on_first_use(self) -> None:
        with runner.isolated_filesystem():
            ...
            with mock_council_query_to_thread(responses):
                result = runner.invoke(app, ["council", "ask", "What is caching?"])
    ...
    def test_ask_continues_existing_thread(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "First question"])
                result = runner.invoke(app, ["council", "ask", "Follow up"])
    ...
    def test_ask_thread_new_starts_fresh(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "First topic"])
                first_thread = get_current_thread(base, BRANCH)

                runner.invoke(app, ["council", "ask", "--new-thread", "New topic"])
    ...
    def test_ask_to_specific_member(self) -> None:
        with runner.isolated_filesystem():
            ...
            with patch("kingdom.council.base.subprocess.run", return_value=mock_result):
                result = runner.invoke(app, ["council", "ask", "--to", "codex", "Tell me more"])
    ...
    def test_ask_to_creates_thread_with_only_target_member(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            with patch("kingdom.council.base.subprocess.run", return_value=mock_result):
                runner.invoke(app, ["council", "ask", "--to", "codex", "Hello"])
    ...
    def test_ask_to_unknown_member_fails(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "ask", "--to", "unknown", "Hello"])
    ...
    def test_ask_stale_current_thread_recovers(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                result = runner.invoke(app, ["council", "ask", "After stale"])
    ...
    def test_ask_json_output(self) -> None:
        with runner.isolated_filesystem():
            ...
            with mock_council_query(responses):
                result = runner.invoke(app, ["council", "ask", "--json", "Test"])
    ...
    def test_ask_does_not_modify_non_kd_files(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                result = runner.invoke(app, ["council", "ask", "Analyze only"])
    ...
    def test_ask_saves_sessions(self) -> None:
        with runner.isolated_filesystem():
            ...
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "Test"])
...
class TestCouncilShow:
    def test_show_current_thread(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "What is caching?"])

            result = runner.invoke(app, ["council", "show"])
    ...
    def test_show_specific_thread(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "Question 1"])
                thread_id = get_current_thread(base, BRANCH)

            result = runner.invoke(app, ["council", "show", thread_id])
    ...
    def test_show_legacy_run_fallback(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", "run-abcd"])
    ...
    def test_show_not_found_errors(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", "nonexistent"])
...
class TestCouncilShowPagination:
    ...
    def test_last_n_shows_requested_turns(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", thread_id, "--last", "2"])
    ...
    def test_all_shows_every_turn(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", thread_id, "--all"])
    ...
    def test_single_turn_shows_no_hidden_summary(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "Single question"])
    ...
    def test_last_n_clamped_to_total(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", thread_id, "--last", "100"])
...
class TestCouncilList:
    def test_list_no_threads(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "list"])
    ...
    def test_list_shows_threads(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "Topic 1"])
                runner.invoke(app, ["council", "ask", "--new-thread", "Topic 2"])
    ...
    def test_list_shows_topic_summary(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "Should we use Redis or Memcached?"])
    ...
    def test_list_shows_member_status(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "A question"])
...
class TestCouncilAskAsync:
    def test_no_watch_returns_immediately(self) -> None:
        with runner.isolated_filesystem():
            ...
            with patch_async_dispatch() as stack:
                ...
                result = runner.invoke(app, ["council", "ask", "--async", "--no-watch", "Test async"])
    ...
    def test_no_watch_creates_thread_and_king_message(self) -> None:
        with runner.isolated_filesystem():
            ...
            with patch_async_dispatch() as stack:
                ...
                runner.invoke(app, ["council", "ask", "--async", "--no-watch", "Async question"])
    ...
    def test_no_watch_passes_to_flag_to_worker(self) -> None:
        with runner.isolated_filesystem():
            ...
            with patch_async_dispatch() as stack:
                mock_popen = enter_async_patches(stack)
                runner.invoke(app, ["council", "ask", "--async", "--no-watch", "--to", "codex", "Test targeted"])
...
class TestCouncilWatch:
    def test_watch_shows_existing_responses(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                runner.invoke(app, ["council", "ask", "Test question"])

            current = get_current_thread(base, BRANCH)
            result = runner.invoke(app, ["council", "watch", current])
    ...
    def test_watch_no_current_thread_errors(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "watch"])
    ...
    def test_watch_nonexistent_thread_errors(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "watch", "nonexistent"])
    ...
    def test_watch_targeted_ask_completes_without_timeout(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            with patch("kingdom.council.base.subprocess.run", return_value=mock_result):
                runner.invoke(app, ["council", "ask", "--to", "codex", "Targeted question"])

            current = get_current_thread(base, BRANCH)
            result = runner.invoke(app, ["council", "watch", current, "--timeout", "1"])
...
class TestCouncilShowLast:
    def test_show_last_no_logs_dir(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", "last"])
...
class TestCouncilMentions:
    def test_single_mention_targets_member(self) -> None:
        with runner.isolated_filesystem():
            ...
            with patch("kingdom.council.base.subprocess.run", return_value=mock_result):
                result = runner.invoke(app, ["council", "ask", "@codex what do you think?"])
    ...
    def test_multiple_mentions_filters_council(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                result = runner.invoke(app, ["council", "ask", "@claude @codex thoughts?"])
    ...
    def test_at_all_queries_everyone(self) -> None:
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                result = runner.invoke(app, ["council", "ask", "@all what do you think?"])
    ...
    def test_unknown_mention_fails(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "ask", "@nobody what?"])
    ...
    def test_to_flag_overrides_mentions(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            with patch("kingdom.council.base.subprocess.run", return_value=mock_result):
                result = runner.invoke(app, ["council", "ask", "--to", "claude", "@codex what?"])
...
class TestCouncilStatus:
    def test_status_shows_all_responded(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "status"])
    ...
    def test_status_specific_thread(self) -> None:
        with runner.isolated_filesystem():
            ...
            thread_id = get_current_thread(base, BRANCH)
            result = runner.invoke(app, ["council", "status", thread_id])
    ...
    def test_status_all_threads(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "status", "--all"])
    ...
    def test_status_verbose_shows_log_paths(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "status", "--verbose"])
...
class TestCouncilReset:
    def test_reset_clears_sessions(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "reset", "--force"])
    ...
    def test_reset_confirms_before_clearing(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "reset"], input="y\n")
    ...
    def test_reset_aborts_on_no(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "reset"], input="n\n")
    ...
    def test_reset_single_member(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "reset", "--force", "--member", "claude"])
    ...
    def test_reset_single_member_confirms(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "reset", "--member", "claude"], input="y\n")
    ...
    def test_reset_unknown_member(self) -> None:
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "reset", "--member", "nonexistent"])
...
class TestCouncilReview:
    def test_review_generates_diff_and_asks(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            responses = make_responses("claude", "codex")
            with mock_council_query_to_thread(responses):
                result = runner.invoke(app, ["council", "review", "--base", "master"])
    ...
    def test_review_includes_file_stats_in_prompt(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            with patch.object(Council, "query_to_thread", side_effect=capture_query):
                result = runner.invoke(app, ["council", "review", "--base", "master"])
    ...
    def test_review_auto_detects_main_branch(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            with mock_council_query_to_thread(responses):
                ...
                result = runner.invoke(app, ["council", "review"])
...
class TestCouncilRetry:
    def test_retry_no_thread(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "retry"])
...
class TestNoResultsMessages:
    ...
    def test_council_show_thread_no_messages_shows_guidance(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", "council-empty"])
...
class TestCouncilThreadResolution:
    ...
    def test_show_prefix_match(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", "council-ab"])
    ...
    def test_status_prefix_match(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "status", "council-cd"])
    ...
    def test_show_not_found_lists_available(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "show", "council-zzzz"])
    ...
    def test_watch_prefix_match(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "watch", prefix])
    ...
    def test_retry_prefix_match(self) -> None:
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(app, ["council", "retry", "council-ef"])
