...
The harness and `kd peasant review` both hardcode automatic pytest+ruff execution. This is broken (`sys.executable` points to kd's tool venv, not the project's) and unnecessary — the coding agents already know how to run tests/lint as part of their work, and council reviewers can verify independently.
